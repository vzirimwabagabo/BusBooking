/**
 * Date normalization utility for trips (Node.js version)
 ...
 */
function normalizeTripDate(trip, originalBaseDate = BASE_DATE) {
  ...
  return {
    ...trip,
    date: normalizedDate,
    originalDate: trip.originalDate || trip.date, // Keep original for reference
  };
}
 ...
 */
function normalizeTripsForDate(trips, originalBaseDate = BASE_DATE) {
 ...
 */
function updateTripsDatesToToday(tripsData, originalBaseDate = BASE_DATE) {
...
module.exports = {
  ...
  addDaysToDate,
  normalizeTripDate,
  normalizeTripsForDate,
  updateTripsDatesToToday,
  BASE_DATE,
};
